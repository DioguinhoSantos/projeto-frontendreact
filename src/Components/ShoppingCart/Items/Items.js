...
export const Items = ({
      ...
      <CarrinhoContainer key={index}>
        <CarrinhoMapContainer>
          ...
          <DescCarrinho>
            ...
            <DivPreco>
              <DescPreco>Valor: R</DescPreco>
              <UINUmber format={"$0,0.00"}>{precoTratado}</UINUmber>
            </DivPreco>
          </DescCarrinho>
          <DescQuant>
            <br />
        ...
        <BotãoRemover onClick={removeItem}>Remover item</BotãoRemover>
      </CarrinhoContainer>
    );
  });
  ...
  return (
    <ItemsContainer>
      ...
      <ValorTotalContainer>
        <Valor>Total: R</Valor>
        <UINUmber format={"$0,0.00"}>{amountState}</UINUmber>
      </ValorTotalContainer>
    </ItemsContainer>
  );
};
